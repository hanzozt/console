...
export class OverridesService {
    ...
    constructor(
        @Inject(ZITI_DATA_SERVICE) private ztDataService: ZitiDataService,
        private growlerService: GrowlerService
    ) {}

    loadOverrides(identity): Promise<any> {
        return this.ztDataService.get(`identities/${identity.id}/service-configs`, {}, []).then((result) => {
    ...
    loadServices(filter): Promise<any> {
        ...
        return this.ztDataService.get(`services`, paging, []).then((result) => {
            return result;
        });
    }
    ...
    loadConfigs(filter): Promise<any> {
        ...
        return this.ztDataService.get(`configs`, paging, []).then((result) => {
            return result;
        });
    }
    ...
    addOverride(identity, selectedServiceId, selectedConfigId): Promise<any> {
        ...
        return this.ztDataService.saveSubdata('identities' , identity.id, 'service-configs', data).then(() => {
            const growlerData = new GrowlerModel(
                'success',
                'Success',
                `Override Added`,
    ...
    removeOverride(identity, override): Promise<any> {
        ...
        return this.ztDataService.deleteSubdata('identities' , identity.id, 'service-configs', data).then(() => {
            const growlerData = new GrowlerModel(
                'success',
                'Success',
                `Override Removed`,
