...
export class ServicePoliciesPageService extends ListPageServiceClass {
    ...
    public getServiceRoleAttributes() {
        return this.ztService.get('service-role-attributes', {}, []).then((result) => {
    ...
    public getIdentityNamedAttributes() {
        return this.ztService.get('identities', {rawFilter: true, filter: '', sort: 'name', order: 'asc', total: -1, page: 1}, []).then((result) => {
    ...
    public getServiceNamedAttributes() {
        return this.ztService.get('services', {rawFilter: true, filter: '', sort: 'name', order: 'asc', total: -1, page: 1}, []).then((result) => {
    ...
    public getPostureNamedAttributes() {
        return this.ztService.get('posture-checks', {}, []).then((result) => {
