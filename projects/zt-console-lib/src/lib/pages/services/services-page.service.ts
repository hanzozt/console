...
export class ServicesPageService extends ListPageServiceClass {
    ...
    public getServiceRoleAttributes() {
        return this.ztService.get('service-role-attributes', {}, []).then((result: any) => {
    ...
    public getIdentityRoleAttributes() {
        return this.ztService.get('identity-role-attributes', {}, []);
    }
    ...
    getAllServicesAndOrphans(selectedItems) {
        ...
        selectedItems.forEach((service: any) => {
            ...
            const allCfgAssociationsPromise = new Promise((resolve, reject) => {
                this.ztService.getSubdata('services', service.id, 'configs').then((result) => {
                    const configs = result.data;
                    configs.forEach((config) => {
                        const cfgProm = this.ztService.getSubdata('configs', config.id, 'services').then((result) => {
            ...
            const allSvcAssociationsPromise = new Promise((resolve, reject) => {
                this.ztService.getSubdata('services', service.id, 'service-policies').then((result) => {
