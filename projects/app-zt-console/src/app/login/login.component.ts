...
import {AuthService, SettingsServiceClass, LoginServiceClass, ZitiDataService, SETTINGS_SERVICE, ZAC_LOGIN_SERVICE, ZITI_DATA_SERVICE} from "zt-console-lib";
...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    getExternalJwtSigners() {
        ...
        this.ztService.get('external-jwt-signers', this.ztService.DEFAULT_PAGING, [], undefined, true).then((results) => {
