...
import {SettingsServiceClass, LoginServiceClass, SETTINGS_SERVICE, ZITI_DOMAIN_CONTROLLER, ZAC_LOGIN_SERVICE} from "zt-console-lib";
import { SimpleZitiDomainControllerService} from './services/simple-zt-domain-controller.service';
import { Router } from '@angular/router';
import {MatDialog} from "@angular/material/dialog";
import {ZAC_VERSION} from "zt-console-lib";
...
export class AppComponent implements OnInit {
    ...
    constructor(
        ...
        @Inject(ZITI_DOMAIN_CONTROLLER) private ztControllerService: SimpleZitiDomainControllerService,
