...
import {SimpleZitiDomainControllerService} from "./services/simple-zt-domain-controller.service";
...
import {ZitiApiInterceptor} from "./interceptors/zt-api.interceptor";
...
import { DEFAULT_APP_CONFIG_PROP } from 'projects/zt-console-lib/src/lib/default-app-config';

let loginService, ztDataService, settingsService, wrapperService, apiInterceptor;
if (environment.nodeIntegration) {
    loginService = NodeLoginService;
    ztDataService = NodeDataService;
    settingsService = NodeSettingsService;
    apiInterceptor = NodeApiInterceptor;
}else {
    loginService = ControllerLoginService;
    ztDataService = ZitiControllerDataService;
...
@NgModule({
    ...
    providers: [
        ...
        {provide: ZITI_DATA_SERVICE, useClass: ztDataService},
